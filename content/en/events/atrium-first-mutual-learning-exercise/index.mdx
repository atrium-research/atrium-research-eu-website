...
The first ATRIUM MLE was focused on GoTriple, a service offered by OPERAS Research Infrastructure that is also part of the ATRIUM Service Catalogue. The MLE was organised by ATRIUM in partnership with FECYT, which leads OPERAS-ES, the Spanish Node of OPERAS.
...
For more information, please read the summary of the event [here](https://www.atrium-research.eu/news/atrium-first-mutual-learning-exercise/) or the full report on [Zenodo here](https://zenodo.org/records/15728985).&#x20;
