...
Before sending an application, please review the list of our academic staff (<Link link={{"discriminant":"external"}}>https\://ufal.mff.cuni.cz/people</Link>) and contact them prior to completing your application. Please also include the name of the academic and their field of activity in your application form.
