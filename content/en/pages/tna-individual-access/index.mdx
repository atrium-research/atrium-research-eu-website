...
<Grid variant="one-two-columns">
  ...
  <GridItem>
    <Figure src="/assets/content/en/pages/tna-individual-access/screenshot-2024-10-31-at-08.47.56.png" alt="A group of TNA participants from the R Summer School in Brno" alignment="stretch">

    </Figure>

    Have a read of testimonials from former TNA recipients here

    <LinkButton label="TNA Blog" href="https://atrium-research.eu/blog/" />
  </GridItem>
</Grid>
