...
VELab offers personalised access on the topic of HBIM data and operation workflows, scan2BIM interoperability issues, the ‘H’ aspect of HBIM, multi-discipline data integration through HBIM for built heritage conservation, as well as the use of BIM-to-XR/VR interfaces in Cultural Heritage. Applicants must have a basic knowledge of BIM software/modelling.
...
![Logo of the Cyprus Insitute in dark blue](/assets/content/en/pages/virtual-environments-lab-the-cyprus-institute-nicosia-cyprus/logo.png)
