...
**Contact:** Douglas Tudhope (<Link link={{"discriminant":"external","value":"douglas.tudhope@southwales.ac.uk"}}>douglas.tudhope\@southwales.ac.uk</Link>)
...
The most prominent services are briefly listed below. For further details, see ARIADNEPlus D15.2 <Link link={{"discriminant":"external"}}>[https://zenodo.org/records/7528755](https://zenodo.org/records/7528755)</Link> and [https://pure.southwales.ac.uk/en/persons/ceri-binding/projects/](https://pure.southwales.ac.uk/en/persons/ceri-binding/projects/)
