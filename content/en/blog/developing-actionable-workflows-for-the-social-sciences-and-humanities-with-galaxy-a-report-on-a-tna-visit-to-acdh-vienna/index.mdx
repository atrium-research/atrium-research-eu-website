---
title: >-
  Developing actionable workflows for the social sciences and humanities with
  Galaxy: A report on a TNA visit to ACDH, Vienna
publicationDate: 2026-05-22
image: >-
  /assets/content/en/blog/developing-actionable-workflows-for-the-social-sciences-and-humanities-with-galaxy-a-report-on-a-tna-visit-to-acdh-vienna/image.png
authors:
  - Eamon Bell
summary: >
  In this blog post, I explain what research workflows are, why they matter for
  social science and humanities research, and what I learned about turning them
  into something researchers can actually use—using the Galaxy Project’s
  workflow manager infrastructure as a concrete example.
bannerImage: >-
  /assets/content/en/blog/developing-actionable-workflows-for-the-social-sciences-and-humanities-with-galaxy-a-report-on-a-tna-visit-to-acdh-vienna/bannerImage.webp
---


<Figure src="/assets/content/en/blog/developing-actionable-workflows-for-the-social-sciences-and-humanities-with-galaxy-a-report-on-a-tna-visit-to-acdh-vienna/screenshot-2026-05-22-at-10.00.47.png" alignment="stretch">
...
<Figure src="/assets/content/en/blog/developing-actionable-workflows-for-the-social-sciences-and-humanities-with-galaxy-a-report-on-a-tna-visit-to-acdh-vienna/picture1.png" alignment="stretch">


  | Illustration of the Galaxy graphical workflow editor. Laila Los, Creating high resolution images of Galaxy Workflows (Galaxy Training Materials).[ https://training.galaxyproject.org/training-material/topics/galaxy-interface/tutorials/workflow-posters/tutorial.html](https://training.galaxyproject.org/training-material/topics/galaxy-interface/tutorials/workflow-posters/tutorial.html). Online. Accessed April 21 2026. |
  | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
</Figure>
...
ORCID:[ 0000-0002-9211-5192](https://orcid.org/0000-0002-9211-5192)

Personal homepage:[ https://www.eamonnbell.com](https://www.eamonnbell.com),&#x20;

Staff page:[ https://www.durham.ac.uk/staff/eamonn-bell/](https://www.durham.ac.uk/staff/eamonn-bell/)) is Assistant Professor in the Department of Computer Science, Durham University. He is involved in the design and delivery of several digital research infrastructure (DRI) projects serving UK-based arts, humanities, and culture researchers. These include Toward a Collaborative Computational Project (CCP) for Arts, Humanities, and Culture Researchers ([CCP-AHC](https://www.ccpahc.ac.uk/)) (as Project Lead), and Digital Skills in Arts and Humanities ([DISKAH](http://culturedigitalskills.org)): Transforming Access to Digital Infrastructure and Skills (as Project co-Lead).
