...
| **Researcher**          | Ioannis Tzachristas                                                                                                        |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Host institution**    | UNESCO Chair on Digital Methods for the Humanities and Social Sciences, Athens University of Economics and Business (AUEB) |
| **Academic supervisor** | Prof. John Pavlopoulos                                                                                                     |
| **Visit dates**         | 28 May 2026 - 5 June 2026                                                                                                  |
| **Location**            | Trias 2, 113 62, Athens, Greece                                                                                            |
| **TNA project title**   | Mapping the Moral Behavior of AI Systems: An Ethical Dilemma-Based Study of Large Language Models                          |
| **Resulting paper**     | Aristotelian Virtue Profiling of LLMs through Ethical Dilemmas                                                             |
