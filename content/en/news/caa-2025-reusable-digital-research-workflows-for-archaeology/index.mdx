...
image: >-
  /assets/content/en/news/caa-2025-reusable-digital-research-workflows-for-archaeology/image.HEIC
summary: >
...
### Paper 1: Leveraging AI for Enhanced Archaeological Data Extraction: Workflows for Textual and Image-Based Data – Petr Pajdla (Speaker), David Novák, Ronald Harasim, Dana Křivánková, Pavel Straňák, Kateryna Lutsai, Olga Lečbychová
...
Historical maps are complex, multidimensional artefacts—simultaneously textual, visual, spatial, and cultural—whose layered histories and narrative potential are often obscured. Annotation is proposed as a means to unlock these hidden layers of meaning and make the maps more analytically accessible.&#x20;
