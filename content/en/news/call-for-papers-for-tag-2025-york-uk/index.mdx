...
summary: |
  ATRIUM is seeking paper submissions for TAG 2025 in York, UK. 
...
Contact: [info@atrium-research.eu](mailto:info@atrium-research.eu) 
...
ATRIUM is delighted to invite contributions to the upcoming session at [TAG 2025 ](https://tag2025.hosted.york.ac.uk/en/)that critically examine the environmental impact of archaeological practices: both digital and physical. We encourage and support a diverse set of speakers that explore how sustainability challenges can provoke deeper reflection on research workflows, epistemologies, and ethics.&#x20;
